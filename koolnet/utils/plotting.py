...
def plot_window(data, win_coords, obst_pos, pred):
	...
	# Wind coord plot space
	wx0ps, wx1ps, wy0ps, wy1ps = wx0, wx1, wy0, wy1
	...
	axs[0].fill(
		...
		(np.array([wy0ps, wy0ps, wy1ps, wy1ps])),
		color=(0.7, 0.2, 0.3, 0.65)
	)

	scale_pred_x = (wx0 + pred[0])
	scale_pred_y = (wy0ps + pred[1])
...
def main():
	...
	plot_window(xi, win_coord, obst_pos, [50, -50])
